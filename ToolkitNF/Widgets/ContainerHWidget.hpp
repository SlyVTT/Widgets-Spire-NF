...
/// ContainerHWidget class.
///
/// The class to be used for using a ContainerHWidget control widget.
...
public:
    ...
    ContainerHWidget( std::string l, unsigned int x, unsigned int y, unsigned int w, unsigned int h, Widget *p );
    ...
    /// The ContainerHWidget logic mechanism
    ///
    /// Widget method to be launched to drive the the mechanics behind the ContainerHWidget behavior.
