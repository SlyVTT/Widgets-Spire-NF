...
void CommuterWidget::Render( void )
{
    if (is_visible)
    {
        ...
        else if (!is_ticked && (typetick == Style1 ))
        {
        ...
        else if (is_ticked && (typetick == Style2 ))
        {
        ...
        else if (is_ticked && (typetick == Style3 ))
        {
        ...
        else if (is_ticked && (typetick == Style4 ))
        {
            color = ColorEngine::GetColor(ColorEngine::Widget_Commuter_Active_Filling_Style3);
            colorg = ColorEngine::GetColor(ColorEngine::Widget_Commuter_Active_Cursor_Style3);
        }
        ...
        if (is_enabled)
        {
            ScreenRenderer::DrawFilledRoundedRectangle( xpos, ypos+height/2-6, xpos+24, ypos+height/2+6, 6, color );
            if (!is_hovering)
            {
                ScreenRenderer::DrawRoundedRectangle( xpos, ypos+height/2-6, xpos+24, ypos+height/2+6, 6, ColorEngine::GetColor(ColorEngine::Widget_Border_Enable) );
            }
            else
            {
                ScreenRenderer::DrawRoundedRectangle( xpos, ypos+height/2-6, xpos+24, ypos+height/2+6, 6, ColorEngine::GetColor(ColorEngine::Widget_Border_Cursoron) );
            }

            if ((is_ticked && !is_reversed) || (!is_ticked && is_reversed))
            {
                ScreenRenderer::DrawFilledCircle( xpos+6, ypos+height/2, 4, colorg );
                if (!is_hovering)
                {
                    ScreenRenderer::DrawCircle(  xpos+6, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Border_Enable) );
                }
                else
                {
                    ScreenRenderer::DrawCircle(  xpos+6, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Border_Cursoron) );
                }
            }
            else
            {
                ScreenRenderer::DrawFilledCircle( xpos+18, ypos+height/2, 4, colorg );
                if (!is_hovering)
                {
                    ScreenRenderer::DrawCircle(  xpos+18, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Border_Enable) );
                }
                else
                {
                    ScreenRenderer::DrawCircle(  xpos+18, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Border_Cursoron) );
                }
            }
            ...
            if (drawablecharlabel!=0)
            {
                ...
                FontEngine::DrawStringLeft(  drawablelabel, xpos+30, ypos+(height-sh)/2, ColorEngine::GetColor(ColorEngine::Widget_Text_Enable) );
            }
        }
        else
        {

            ScreenRenderer::DrawFilledRoundedRectangle( xpos, ypos+height/2-6, xpos+24, ypos+height/2+6, 6, ColorEngine::GetColor(ColorEngine::Widget_Filling_Disable) );

            ScreenRenderer::DrawRoundedRectangle(  xpos, ypos+height/2-6, xpos+24, ypos+height/2+6, 3, ColorEngine::GetColor(ColorEngine::Widget_Border_Disable) );


            if ((is_ticked && !is_reversed) || (!is_ticked && is_reversed))
            {
                ScreenRenderer::DrawFilledCircle( xpos+6, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Filling_Disable) );
                ScreenRenderer::DrawCircle( xpos+6, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Border_Disable) );

            }
            else
            {
                ScreenRenderer::DrawFilledCircle( xpos+18, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Filling_Disable) );
                ScreenRenderer::DrawCircle( xpos+18, ypos+height/2, 4, ColorEngine::GetColor(ColorEngine::Widget_Border_Disable) );
            ...
            if (drawablecharlabel!=0)
            {
                ...
                int sh =FontEngine::GetStringHeight( drawablelabel );
                FontEngine::DrawStringLeft(  drawablelabel, xpos+30, ypos+(height-sh)/2, ColorEngine::GetColor(ColorEngine::Widget_Text_Disable) );
            }
